"""NOTE THAT THIS IS ONLY THE PROTOTYPE. THE PROTOTYPE ADDRESSES THE PROBLEM WHOLELY AND ACCURATELY. HOWEVER, WE WANT TO DEVELOP ON THIS IDEA FURTHER AND 
CREATE A ONE STOP DESTINATION FOR SCIENTIFIC AUTHORS WHERE THEY CAN BUILD THEIR PROFILES ON THE PROTAL ITSELF AND MAKE THEIR WRITING JOURNEYS SMOOTHER!
FOR THIS, WE SHALL BE USING THE TECHNOLOGY MENTIONED IN THE PPT, AND NOT ONLY PYTHON! THE PROTOTYPE HAS BEEN DEVELOPED IN PYTHON TO HONOR THE TIMEFRAME 
AND GIVE THE EVALUATOR A SMALL GLIMPSE OF WHAT OUR ACTUAL PROGRAM SHALL BE ABLE TO DO! """
